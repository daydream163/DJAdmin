...
import com.bigfoot.model.GoodsList;
...
public class GoodsListActivity extends BaseFragmentActivity {
    ...
    QuickAdapter<GoodsList> adapter;
    ...
    private void loadData() {
        ...
        HttpClient.form("https://www.meiminger.com/api/appgoods/getlist", param, new HttpResponseHandler() {
            @Override
            public void onSuccess(RestApiResponse response) {
                if (response.isStatus()) {
                    listView.onRefreshComplete();
                    List<GoodsList> list = JSONArray.parseArray(response.getData().toString(), GoodsList.class);
